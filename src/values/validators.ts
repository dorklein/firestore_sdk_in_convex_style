 ...
 */
export class VId<Type, IsOptional extends OptionalProperty = "required"> extends BaseValidator<
  Type,
  IsOptional
> {
  /**
...
> extends BaseValidator<Type, IsOptional, FieldPaths> {
   ...
   */
  constructor({ isOptional, fields }: { isOptional: IsOptional; fields: Fields }) {
    super({ isOptional });
    this.fields = fields;
  }
  /** @internal */
 ...
 */
export class VLiteral<Type, IsOptional extends OptionalProperty = "required"> extends BaseValidator<
  Type,
  IsOptional
> {
  /**
  ...
  get json(): ValidatorJSON {
    return {
      type: this.kind,
      value: this.value as JSONValue, // todo: fix this
    };
  }
  /** @internal */
  asOptional() {
...
> extends BaseValidator<Type, IsOptional> {
   ...
   */
  constructor({ isOptional, element }: { isOptional: IsOptional; element: Element }) {
    super({ isOptional });
...
> extends BaseValidator<Type, IsOptional, FieldPaths> {
   ...
   */
  constructor({ isOptional, key, value }: { isOptional: IsOptional; key: Key; value: Value }) {
    super({ isOptional });
...
> =
  ...
  | VObject<Type, Record<string, Validator<any, OptionalProperty, any>>, IsOptional, FieldPaths>
