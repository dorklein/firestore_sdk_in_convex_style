 ...
 * @public
 */
export function asObjectValidator<V extends Validator<any, any, any> | PropertyValidators>(
  obj: V
 ...
 * @public
 */
export type AsObjectValidator<V extends Validator<any, any, any> | PropertyValidators> =
  V extends Validator<any, any, any>
    ? V
    : V extends PropertyValidators
      ? Validator<ObjectType<V>>
...
type RequiredKeys<PropertyValidators extends Record<string, GenericValidator>> = Exclude<
  keyof PropertyValidators,
  OptionalKeys<PropertyValidators>
>;
