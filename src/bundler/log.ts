...
import ProgressBar, { ProgressBarInstance, ProgressBarOptions } from "../vendor/progress/index.js";
...
export async function showSpinnerIfSlow(message: string, delayMs: number, fn: () => Promise<any>) {
