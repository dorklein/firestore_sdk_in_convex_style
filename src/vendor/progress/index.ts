...
const ProgressBar: ProgressBarConstructor = function (
  ...
  if (typeof options == "number") {
    ...
    if ("number" != typeof (options as ProgressBarOptions).total) throw new Error("total required");
  }
  ...
  this.chars = {
    ...
    head: (options as ProgressBarOptions).head || (options as ProgressBarOptions).complete || "=",
  };
  this.renderThrottle =
...
ProgressBar.prototype.render = function (
  ...
  var availableSpace = Math.max(0, (this.stream as any).columns - str.replace(":bar", "").length);
 ...
 * @api public
 */
ProgressBar.prototype.interrupt = function (this: ProgressBarInstance, message: string): void {
