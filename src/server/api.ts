...
>(name: string): FunctionReference<type, "public", args, ret> {
  return { [functionName]: name } as unknown as FunctionReference<type, "public", args, ret>;
}
  ...
  [mod in keyof API as API[mod] extends Predicate
    ...
    : API[mod] extends FunctionReference<any, any, any, any>
      ...
      : FilterApi<API[mod], Predicate> extends Record<string, never>
        ? never
        : mod]: API[mod] extends Predicate ? API[mod] : FilterApi<API[mod], Predicate>;
}>;
...
// ): FilterApi<
//   API,
//   FunctionReference<"query", any, { paginationOpts: PaginationOptions }, PaginationResult<any>>
// > {
//   return api as any;
// }
