import { FirestoreConvexStyleError } from "../../values/errors.js";
...
export async function performAsyncSyscall(op: string, arg: Record<string, any>): Promise<any> {
  ...
  try {
    ...
    if (e.data !== undefined) {
      const rethrown = new FirestoreConvexStyleError(e.message);
