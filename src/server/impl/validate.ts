export function validateArg(arg: any, idx: number, method: string, argName: string) {
  if (arg === undefined) {
    throw new TypeError(`Must provide arg ${idx} \`${argName}\` to \`${method}\``);
  }
}

export function validateArgIsInteger(arg: any, idx: number, method: string, argName: string) {
